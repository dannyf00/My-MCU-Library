#include "tim17oc.h"					//using timer output compare channels as timer

//hardware configuration
//end hardware configuration

//global defines
#define RCC_TIMxEN						RCC_APB2ENR_TIM17EN
#define TIMx							TIM17
#define TIMx_CC_IRQn					TIM1_TRG_COM_TIM17_IRQn
...
//global variables
static void (* _tim_oc1isrptr)(void)=empty_handler;				//tim17_ptr pointing to empty_handler by default
static void (* _tim_oc2isrptr)(void)=empty_handler;				//tim17_ptr pointing to empty_handler by default
static void (* _tim_oc3isrptr)(void)=empty_handler;				//tim17_ptr pointing to empty_handler by default
static void (* _tim_oc4isrptr)(void)=empty_handler;				//tim17_ptr pointing to empty_handler by default
...
//isr for timer15 capture / compare
...
//initialize tim17 to use compare channels as timers

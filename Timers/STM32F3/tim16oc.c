#include "tim16oc.h"					//using timer output compare channels as timer

//hardware configuration
//end hardware configuration

//global defines
#define RCC_TIMxEN						RCC_APB2ENR_TIM16EN
#define TIMx							TIM16
#define TIMx_CC_IRQn					TIM1_UP_TIM16_IRQn
...
//global variables
static void (* _tim_oc1isrptr)(void)=empty_handler;				//tim16_ptr pointing to empty_handler by default
static void (* _tim_oc2isrptr)(void)=empty_handler;				//tim16_ptr pointing to empty_handler by default
static void (* _tim_oc3isrptr)(void)=empty_handler;				//tim16_ptr pointing to empty_handler by default
static void (* _tim_oc4isrptr)(void)=empty_handler;				//tim16_ptr pointing to empty_handler by default
...
//initialize tim16 to use compare channels as timers

#include "tim15oc.h"					//using timer output compare channels as timer

//hardware configuration
//end hardware configuration

//global defines
#define RCC_TIMxEN						RCC_APB2ENR_TIM15EN
#define TIMx							TIM15
#define TIMx_CC_IRQn					TIM1_BRK_TIM15_IRQn
...
//global variables
static void (* _tim_oc1isrptr)(void)=empty_handler;				//tim15_ptr pointing to empty_handler by default
static void (* _tim_oc2isrptr)(void)=empty_handler;				//tim15_ptr pointing to empty_handler by default
static void (* _tim_oc3isrptr)(void)=empty_handler;				//tim15_ptr pointing to empty_handler by default
static void (* _tim_oc4isrptr)(void)=empty_handler;				//tim15_ptr pointing to empty_handler by default
...
//initialize tim15 to use compare channels as timers

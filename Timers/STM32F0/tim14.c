...
#include "tim14.h"						//we use hardware timer
...
//global defines
#define TIMx		TIM14
#define RCC_TIMx	RCC_APB1Periph_TIM14
...
//timer set to
void tmr14_init(uint16_t ps, uint16_t period) {
...
void tmr14_act(void (*isr_ptr)(void)) {
	...
	//enable tim4 irq
	NVIC_InitStructure.NVIC_IRQChannel = TIM14_IRQn;	//tim4 irq

...
#include "tim17.h"						//we use hardware timer
...
//global defines
#define TIMx		TIM17
#define RCC_TIMx	RCC_APB2Periph_TIM17
...
//timer set to
void tmr17_init(uint16_t ps, uint16_t period) {
...
void tmr17_act(void (*isr_ptr)(void)) {
	...
	//enable tim4 irq
	NVIC_InitStructure.NVIC_IRQChannel = TIM17_IRQn;	//tim4 irq
